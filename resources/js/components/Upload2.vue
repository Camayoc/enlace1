...
export default {
	...
	methods: {
		...
		upload() {
            ...
            const blob = data2blob(createImgUrl, mime)
            ...
            if(this.overrideUpload==null){
                ...
                let tthis = this
                this.overrideUpload(createImgUrl).then((result) => {
                    tthis.loading = 2;
					console.log(result)
                    //this.loading = 2;
                    this.$emit('crop-upload-success', { createImgUrl,field, ki});

                }).catch((err) => {
					console.log(err)
                    //this.value = true
                    //tthis.loading = 3
                    //tthis.errorMsg = lang.fail;
                    //tthis.$emit('update:value',false)
                    //this.$emit('crop-upload-fail', tthis.sts, tthis.field, tthis.ki);
                });
            }
