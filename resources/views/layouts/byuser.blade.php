...
<body>
    <div id="app">
        <header class="navbar navbar-expand-md navbar-light shadow-sm danmer-nav-contaifner"  id="header">
            <nav class="container-profile danmer-container">
                ...
                @yield('edit.photoheader')
                <div class="danmer-hidden-header">
                    <div class="profile">
                        <img id="id-profile" src="{{$user->profile}}"
                            alt="">
                        @yield('edit.photomini')
